...
//             matchStage['slot.startDate'] = { $gte: new Date(exam_start_date) };
//         }
//         if (organisation_name !== null) {
//             matchStage['event_assessment.organisation.org_name'] = { $regex: organisation_name, $options: 'i' };
...
//         const events = await assessmenteventDetailModel.find({}); // Fetch all events
